...
public:
	...
	trtc_client(gui2::tdialog& dialog, const tpoint& desire_size, bool local_only = false);
	virtual ~trtc_client();
...
{
public:
	tavcapture(gui2::tdialog& dialog, const tpoint& desire_size = tpoint(nposm, nposm));
};
